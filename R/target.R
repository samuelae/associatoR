...
#'
#' @param associations an \code{associatoR} object containing association data as generated by \link[associatoR]{ar_import}.
#' @param characteristics a \code{character} string or vector specifying the characteristics using one or more from \code{c("valence", "arousal", "dominance", "concreteness", "frequency")} or a dataset containing characterisics. The dataset must contain a column \code{word}.
#'
...
ar_characterize_targets <- function(associations,
  ...
  if(chk::vld_character(characteristics)){
    ...
    stop("Argument characteristics must be a character vector or tibble.")
    }
