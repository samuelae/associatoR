...
#' @param protect_cues a \code{logical} specifying whether to protect the cues from normalization \code{fun} to cues as well.
#'
...
#'
ar_normalize_manual <- function(x, fun, ..., protect_cues = TRUE) {
